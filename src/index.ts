...
const buttonStyle = 'bg-blue-800 text-white p-2 ring-2 ring-blue-300 rounded-lg text-slate-500 hover:bg-blue-500 hover:ring-purple-200 hover:text-white  hover:text-bold'
...
Inputs({ idContainer: "homepage", tagName: "button", name: "Submit", style:buttonStyle });
